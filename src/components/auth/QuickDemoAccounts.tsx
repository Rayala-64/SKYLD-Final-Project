...
const testAccounts: TestAccount[] = [
  ...
  { label: "Mentor 1", email: "mentor1@skyld.com", role: "mentor", icon: Users },
  { label: "Mentor 2", email: "mentor2@skyld.com", role: "mentor", icon: Users },
  { label: "Student 1", email: "student1@skyld.com", role: "student", icon: GraduationCap },
  { label: "Student 2", email: "student2@skyld.com", role: "student", icon: GraduationCap },
  { label: "Student 3", email: "student3@skyld.com", role: "student", icon: GraduationCap },
  { label: "Student 4", email: "student4@skyld.com", role: "student", icon: GraduationCap },
  { label: "Student 5", email: "student5@skyld.com", role: "student", icon: GraduationCap },
  { label: "Student 6", email: "student6@skyld.com", role: "student", icon: GraduationCap },
];
    ...
    <div className="mt-6 pt-5 border-t border-white/10">
      <div className="flex items-center justify-between mb-3">
        <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
          <UserCheck className="w-3.5 h-3.5 text-primary" /> Quick Test Accounts
        </span>
